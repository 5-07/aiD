  ...
  return (
    ...
    >
      ...
      <div className="container relative mt-16">
        <h1 className=" text-8xl md:text-[168px] md:leading-none font-semibold tracking-tighter bg-white bg-[radial-gradient(100%_100%_at_top_left,white,white,rgb(74,32,138,.5))] text-transparent bg-clip-text text-center">aiD: AI ChatBot</h1>
        <p className="text-lg md:text-xl text-white/70 mt-5 text-center max-w-xl mx-auto"> Empowering 24/7 customer care with AI, delivering support that feels human. 
        </p>
